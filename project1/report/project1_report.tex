...
\author{Adithya Lakshmikanth, Amy Vu, Aastha Mishra, Ellie, Disha}
\date{\today}
...
acceleration & 15.541 & 2.759 & 8.000 & 13.775 & 15.500 & 17.025 & 24.800 & 0 & 11 \\
...
Linear dependencies among features and the target variable were quantified using Pearson correlation coefficients. Figure~\ref{fig:auto_mpg_heatmap} illustrates the pairwise correlation heatmap.
...
\subsection{Correlation Analysis}
Linear dependencies among features and the target variable were quantified using Pearson correlation coefficients. Figure~\ref{fig:concrete_heatmap} illustrates the pairwise correlation heatmap.
...
\subsection{Correlation Analysis}
Linear dependencies among features and the target variable were quantified using Pearson correlation coefficients. Figure~\ref{fig:airfoil_heatmap} illustrates the pairwise correlation heatmap.
